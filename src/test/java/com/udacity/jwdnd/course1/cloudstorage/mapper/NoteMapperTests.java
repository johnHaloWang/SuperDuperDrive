...
public class NoteMapperTests {
    ...
    @Test void testUpdateNote(){
        ...
        int noteId = list.get(0).getNoteId();
        test.setNoteId(noteId);
        //Note expected = noteMapper.getNoteByNoteId(noteId);
        ...
        //Note resultNote = noteMapper.getNoteByNoteId(noteId);
    ...
    @Test void testDeleteNote(){
        ...
        //List<Note> result = noteMapper.getAllNotesByUserId(user.getUserId());
